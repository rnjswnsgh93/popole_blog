...
<body>
  ...
  <div id="wrap_global">
    ...
    <br><br>
    <p><a href="/">home</a>><a href="/daily">일상</a>> 일상글쓰기</p>
    <br><br>

    <div class="write_body">
    <form action="daily_WriteAction" method="post" name="write_daily" enctype="multipart/form-data">
    ...
    <input type="hidden" name="id" value="<%=sessionID%>">
      ...
      <textarea name="content" id="" cols="120" rows="10" style="resize: none;"></textarea>
      <script>CKEDITOR.replace('content',{height : '800px',width:'1000px',filebrowserUploadUrl:'/mine/imageUpload.do'});</script>
      <input type="button" value="글 작성" class="daily_button" onclick="checkValue()"style="margin-left: 800px;"> 
    </form>
    <a href="/daily?pagenum=1&pagelast=5"><button class="daily_button" style="position: absolute; bottom: 0px;margin-left: 900px" >글 목록</button></a>    
  	</div>
